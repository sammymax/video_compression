./TAppEncoderStaticd -c ../cfg/encoder_randomaccess_wpp.cfg -wdt 352 -hgt 288 -fr 50 -f 10 --SEIDecodedPictureHash=1 -i bus_cif.yuv -b bus_cif.hevc -o HM_12_0_bus_cif.yuv 
