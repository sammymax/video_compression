./TAppEncoderStatic -c ../cfg/encoder_randomaccess_tile.cfg -wdt 352 -hgt 288 -fr 50 -f 5 --SEIDecodedPictureHash=1 -i /home/bradley/bus_cif.yuv -b bus_cif.hevc -o HM_12_0_bus_cif.yuv 
