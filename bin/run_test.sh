./TAppEncoderStaticd -c ../cfg/encoder_randomaccess_main.cfg -wdt 352 -hgt 288 -q 0 -fr 50 -f 5 --SEIDecodedPictureHash=1 -i /home/bradley/github.com/video_compression/bin/bus_cif.yuv -b bus_cif.hevc -o HM_12_0_bus_cif.yuv 
